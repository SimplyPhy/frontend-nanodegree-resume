...
projects.display = function() {
    for (var key in projects.projects) {
        ...
        for (var photo in projects.projects[key].images) {
            var formattedProjectImages = HTMLprojectImage.replace("%data%", projects.projects[key].images[photo]);
...
education.display = function() {
    for (var key in education.schools) {
        ...
        var formattedEduName = HTMLschoolName.replace("%data%", education.schools[key].name);
        $(".education-entry:last").append(formattedEduName);

        var formattedEduLocation = HTMLschoolLocation.replace("%data%", education.schools[key].location);
        ...
        var formattedEduURL = HTMLschoolURL.replace("%data%", education.schools[key].url);
